...
function OfflineSwitch({ change, label, checked }) {
  return (
    <FormControlLabel
      ...
      label={<span class="material-icons">signal_cellular_nodata</span>}
    />
  );
}
...
function App() {
  ...
  const message = `${enabled ? "cloud_off" : "cloud_queue"}`;
  if (!ready) {
    return <BuildLocalDb complete={() => setReady(true)} />;
  }

  return (
    <div
      className={["App", light ? "light" : "", home ? "home" : ""].join(" ")}
    >
      ...
      <Router>
            ...
            {!(matches && open) && (
              <Link to="/">
                <img
                  ...
                  alt={APP_NAME}
                  src="http://ullify.com/assets/notify.png"
                />
        ...
        <div className="amplify-main-workspace">
          ...
          <Choice>
            ...
            <Route
              path="/recent/:type"
              children={
                <DisplayListView setHome={handleSetHome} recent open={open} />
              }
            />
            <Route
              path="/find/:type/:param"
              children={<DisplayFindView setHome={handleSetHome} open={open} />}
            />
            <Route
              path="/list/:type"
              children={
                <DisplayThumbView setHome={handleSetHome} open={open} />
              }
            />
            <Route
              path="/show/:type/:id"
              children={<DisplayListView setHome={handleSetHome} open={open} />}
            />
            <Route
              path="/show/:type"
              children={<DisplayListView setHome={handleSetHome} open={open} />}
        ...
        <Drawer
          ...
          open={snackMenuOpen}
        >
          <TrackMenu track={editedTrack} local={enabled} />
        </Drawer>
      </Router>
      ...
      <Drawer
        className={clsx({
          [classes.player]: playing && !expanded,
